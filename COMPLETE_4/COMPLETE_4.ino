...
void setup() {
  ...
  if (! rtc.isrunning()) {
   ...
   //rtc.adjust(DateTime(2020, 02, 02, 11, 40, 0));
  }
...
void loop() {
  ...
  lcd.clear();
  lcd.setCursor(3,0);
  lcd.print("SMART SLIP");
  lcd.setCursor(0,1);
  lcd.print("PRINTING MACHINE");
...
int getFingerprintIDez() {
  ...
  Serial.print(" with confidence of ");
          ...
          printer.setSize('S');
          printer.justify('C'); 
          printer.println("PERMITED TO ENTER THE CLASS");
          ...
          printer.printBitmap(signjpg1_width, signjpg1_height, signjpg1_data);
          printer.print("MOHAMMAD ASIF.K \n");
          printer.print("HOS IN EEE \n");
          printer.println("DON'T GET STRESSED");
          
          printer.println("ALWAYS BE ON TIME");
